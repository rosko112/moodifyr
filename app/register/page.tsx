...
export default async function RegisterPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[linear-gradient(180deg,_#fffdf8_0%,_#ecfdf5_100%)] px-6 py-10">
      <div className="grid w-full max-w-5xl gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <div className="max-w-xl">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-600">
            Registriraj se, da boš lahko uporabljal mood-based priporočila,
            povezavo s Spotifyjem in prilagojen glasbeni flow.
          </p>
=======
